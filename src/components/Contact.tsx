    ...
    <section id="contact" className="section-padding bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className={`w-full md:w-2/5 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
            <div className="bg-white p-8 rounded-xl shadow-md h-full">
              <h3 className="text-2xl font-bold text-portfolio-dark mb-6">Get In Touch</h3>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-portfolio-blue/10 p-3 rounded-lg mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-portfolio-gray">alihassan.dev8@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-portfolio-gray">+92 321 691 1480</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-portfolio-gray">Sahiwal, Pakistan</p>
                  </div>
                </div>
              </div>
              
              <div className="mt-10">
                <h4 className="text-lg font-medium text-portfolio-dark mb-4">Follow Me</h4>
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-portfolio-blue/10 flex items-center justify-center text-portfolio-blue hover:bg-portfolio-blue hover:text-white transition-colors duration-300">
          ...
          <div className={`w-full md:w-3/5 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`} style={{ transitionDelay: '0.3s' }}>
